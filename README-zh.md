...
- 🧪 **完整测试体系** — 单元测试 + 集成测试 + E2E 测试，Vitest + Playwright 全覆盖
...
| 用户名         | 密码         | 角色 | 昵称     |
| ----------- | ---------- | -- | ------ |
| `merchant_1` | `pass1234` | 商家 | 李老板    |
| `user_1`     | `pass1234` | 用户 | 竞拍达人小王 |
| `user_2`     | `pass1234` | 用户 | 捡漏专家小李 |
...
│   ├── services/                       #   auction-settle, bid-service-cas
│   ├── ws/                             #   bid-event-bus
│   └── infrastructure/                 #   lua-scripts
├── integration/                        # 集成测试
│   ├── api/                            #   bid-idempotency
...
├── components/auction/__tests__/       #   BidButton, Countdown, Leaderboard, LeaderboardSheet, ProductCard
└── lib/__tests__/                      #   format
```
